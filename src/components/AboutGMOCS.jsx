const AboutGMOCS = () => {
	return (
		<div className="about-gmocs">
			...
			<hr />
			<section id="about-gmocs">
				<p>
					<strong>
						GMOCS (Glittering Minds of Computer Science)
					</strong>{" "}
					is an annual national-level technical symposium hosted by
					the{" "}
					<strong>
					...
					explore and showcase their skills through a series of
					curated events including Workshops on Web Development and
					UI/UX Designing, Project Expos, challenging Tech Quizzes,
					fast-paced Coding Competitions (Code Rush), Ideathons
					focused on innovation, and Paper Presentations promoting
					research and thought leadership. To stimulate creativity and
					fun, GMOCS also offers Non-Technical activities such as
					Sudoku puzzles, Movie-themed games (Movie Mania),
					...
					registration fees (MITSIANS: ₹50/event; Others: ₹100/event),
					and an amazing platform to build skills, network, and gain
					recognition at a national level. The event is guided under
					the leadership of eminent academicians including{" "}
					<strong>
						Dr. N. Vijaya Bhaskar Choudary (Chief Patron)
					</strong>
